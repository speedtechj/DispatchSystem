                ...
                <dl class="flex flex-wrap">
                    <div class="flex-auto pt-6 pl-6">
                        ...
                        <dd class="mt-1 text-lg font-semibold text-gray-900 dark:text-white">
                            {{ $scannedInvoices->invdata->invoice ?? null }}</dd>
                    </div>
                    ...
                    <div
                        ...
                        <dd class="text-sm/6 font-medium text-gray-900 dark:text-white">
                            {{ $scannedInvoices->invdata->sender_name }}</dd>
                    </div>
                    <div
                        ...
                        <dd class="text-lg font-medium text-gray-900 dark:text-white">
                            {{ $scannedInvoices->invdata->receiver_name }}</dd>
                    </div>
                    <div class="mt-4 flex w-full flex-none gap-x-4 px-6">
                        ...
                        <dd class="text-lg text-gray-500 dark:text-gray-300">
                            {{ $scannedInvoices->invdata->receiver_address }}</br>
                        </dd>
                    </div>
                    <div class="mt-4 flex w-full flex-none gap-x-4 px-6">
                        <dt class="flex-none">
                        ...
                        <dd class="text-lg text-gray-500 dark:text-gray-300">
                            {{ $scannedInvoices->invdata->receiver_barangay }}
                        </dd>
                    </div>
                    <div class="mt-4 flex w-full flex-none gap-x-4 px-6">
                        <dt class="flex-none">
                        ...
                        <dd class="text-lg text-gray-500 dark:text-gray-300">
                            {{ $scannedInvoices->invdata->receiver_city }}
                        </dd>
                    </div>
                    <div class="mt-4 flex w-full flex-none gap-x-4 px-6">
                        <dt class="flex-none">
                        ...
                        <dd class="text-lg text-gray-500 dark:text-gray-300">
                            {{ $scannedInvoices->invdata->receiver_province }}
                        </dd>
                    </div>
                    <div class="mt-4 flex w-full flex-none gap-x-4 px-6">
                        <dt class="flex-none">
                        ...
                        <dd class="text-lg text-gray-500 dark:text-gray-300">
                            {{ $scannedInvoices->invdata->boxtype }}
                        </dd>
                    </div>
                </dl>
                                    ...
                                    <tbody class="divide-y divide-gray-200 dark:divide-white/10">
                                        @foreach ($customerinfos as $customerinfo)
                                            <tr>
                                                ...
                                                <td
                                                    class="px-3 py-4 text-sm whitespace-nowrap text-gray-500 dark:text-gray-400">
                                                    {{-- {{ $customerinfo->tripinvoices->deliverylog->trip_number ?? 'No Trip Number'}} --}}
                                                     {{ $customerinfo->tripinvoices->first()->deliverylog->trip_number ?? 'No Trip Number'}}
                                                </td>
                                                <td
                                                    class="px-3 py-4 text-sm whitespace-nowrap text-gray-500 dark:text-gray-400">
                                                ...
                                                <td
                                                    ...
                                                    @if ($customerinfo->tripinvoices->first()?->is_loaded)
