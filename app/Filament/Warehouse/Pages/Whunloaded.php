...
class Whunloaded extends Page {
    protected static ?string $navigationLabel = 'Unload Truck';
  //  protected static string | BackedEnum | null $navigationIcon = Heroicon::Truck;
   protected static string | UnitEnum | null $navigationGroup = 'Warehouse';
    protected ?string $heading = 'Unload Truck';

    protected string $view = 'filament.warehouse.pages.whunloaded';
    ...
    public function form( Schema $schema ): Schema {
        return $schema
        ->components( [
            Section::make( 'Unload Truck' )
            ->schema( [
                Select::make( 'trip_number' )
                ->label( 'Select Trip Number' )
                ->options( Whdeliverylog::where( 'warehouse_id', Auth::user()->warehouse_id )->pluck( 'trip_number', 'id' ) )
                ->required()
                ->searchable()
