...
class Hubloaded extends Page
{
    protected static ?string $navigationLabel = 'Hub Load Truck';
  //  protected static string | BackedEnum | null $navigationIcon = Heroicon::Truck;
   protected static string | UnitEnum | null $navigationGroup = 'Hub';
    protected ?string $heading = 'Hub Load Truck';
    protected string $view = 'filament.warehouse.pages.hubloaded';
